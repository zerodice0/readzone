...
const ToastViewport = ({ className, ref, ...props }) => (_jsx(ToastPrimitives.Viewport, { ref: ref, className: cn('fixed top-4 left-1/2 -translate-x-1/2 z-[100] flex flex-col w-full max-w-sm p-4', className), ...props }));
