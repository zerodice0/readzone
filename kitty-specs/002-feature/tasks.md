...
3. Empty state: Show message + "독후감 작성하기" button
4. Error state: Show message + "다시 시도" button (calls loadFeed)
...
2. Login prompt: Modal or toast with "로그인이 필요합니다" message
...
- **Sequence**: WP01 → WP02, WP03, WP04 (backend modules) → WP05 → WP06, WP07 → WP08 (MVP) → WP09, WP10, WP11 (enhancements)
- **Parallelization**:
